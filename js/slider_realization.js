(function() {
  ...
  function runSlider(selector) {
    ...
    var prevBtn = slider.querySelector(".realization_slider_btn_prev");
    var nextBtn = slider.querySelector(".realization_slider_btn_next");
  ...
  function getCurrentSlideIndex(selector) {
    ...
    var sliderSwitch = document.querySelector(selector).querySelectorAll(".realization_slider_switch");
